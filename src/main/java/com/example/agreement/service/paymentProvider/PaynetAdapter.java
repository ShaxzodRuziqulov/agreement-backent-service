...
@Component
public class PaynetAdapter extends BaseSecretAdapter implements PaymentProviderAdapter {

    @Value("${app.payments.paynet.redirect-base:https://payments.local/paynet}")
    private String redirectBase;

    @Value("${app.payments.paynet.secret:}")
    private String secret;

    @Override public PaymentProvider provider() { return PaymentProvider.PAYNET; }
    ...
    @Override public VerifiedCallback verifyCallback(PaymentCallbackRequest req, String providedSecret) {
        checkSecret(secret, providedSecret, "PAYNET");
