...
@Component
public class UzumAdapter extends BaseSecretAdapter implements PaymentProviderAdapter {

    @Value("${app.payments.uzum.redirect-base:https://payments.local/uzum}")
    private String redirectBase;

    @Value("${app.payments.uzum.secret:}")
    private String secret;

    @Override public PaymentProvider provider() { return PaymentProvider.UZUM; }
    ...
    @Override public VerifiedCallback verifyCallback(PaymentCallbackRequest req, String providedSecret) {
        checkSecret(secret, providedSecret, "UZUM");
